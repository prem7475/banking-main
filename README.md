<div align="center">
  ...
  <div>
    ...
    <img src="https://img.shields.io/badge/-MongoDB_Atlas-black?style=for-the-badge&logoColor=white&logo=mongodb&color=47A248" alt="mongodb" />
  </div>
...
3. 🔋 [Features](#features)
4. 🤸 [MongoDB Atlas Setup](#mongodb-setup)
...
Built with Next.js, UdharPay is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances altogether.
...
## <a name="mongodb-setup">🤸 MongoDB Atlas Setup</a>
...
MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/banking?retryWrites=true&w=majority
...
- User registration with UPI PIN setup
- Secure balance viewing with PIN verification
...
5. Replace `<database>` with your preferred database name (e.g., `udharpay`)
...
```env
MONGODB_URI=mongodb+srv://<username>:<password>@cluster0.xxxxx.mongodb.net/udharpay?retryWrites=true&w=majority
```

### 7. Test the Connection
1. Start your Next.js application
2. Try registering a new user with UPI PIN
3. Check MongoDB Atlas dashboard to verify data is being stored

### 8. Security Notes
- For production, restrict IP access to your server IP
